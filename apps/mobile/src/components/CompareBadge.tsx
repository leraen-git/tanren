...
export function CompareBadge({ percent, trend }: CompareBadgeProps) {
  ...
  return (
    <View style={{ borderWidth: 1, borderColor: color, backgroundColor: `${color}1A`, paddingVertical: 3, paddingHorizontal: 8 }}>
      <Text style={{ fontFamily: fonts.sansB, fontSize: 11, letterSpacing: 0.5, color }}>
        {formatted}
      </Text>
    </View>
  )
